...
namespace CustomCharacter.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Classes",
                columns: new[] { "Id", "ClassName", "StatModifier" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "permissions", "create", "dungeonmaster" },
                    { 2, "permissions", "update", "dungeonmaster" },
                    { 3, "permissions", "delete", "dungeonmaster" },
                    { 4, "permissions", "create", "creator" },
